...
NJS_MATERIAL matlist_PacmanDummy[] = {
	{ { 0xFFB2B2B2 }, { 0xFFFFFFFF }, 11, 0, NJD_D_100 | NJD_FILTER_BILINEAR | NJD_FLAG_IGNORE_LIGHT | NJD_DA_ONE | NJD_SA_SRC }
};

Sint16 poly_PacmanDummy[] = {
	0, 1, 2
};

NJS_TEX uv_PacmanDummy[] = {
	{ 0, 255 },
	{ 255, 255 },
	{ 0, 229 }
};

NJS_MESHSET_SADX meshlist_PacmanDummy[] = {
	{ NJD_MESHSET_TRIMESH | 0, 1, poly_PacmanDummy, NULL, NULL, NULL, uv_PacmanDummy, NULL }
};

NJS_VECTOR vertex_PacmanDummy[] = {
	{ 36.18997f, -15.76906f, -0.00001f },
	{ -36.18997f, -15.76906f, -0.00001f },
	{ -36.18997f, -19.71133f, -0.00001f }
};

NJS_VECTOR normal_PacmanDummy[] = {
	{ 0, 0, 1 },
	{ 0, 0, 1 },
	{ 0, 0, 1 }
};

NJS_MODEL_SADX attach_PacmanDummy = { vertex_PacmanDummy, normal_PacmanDummy, LengthOfArray<Sint32>(vertex_PacmanDummy), meshlist_PacmanDummy, matlist_PacmanDummy, LengthOfArray<Uint16>(meshlist_PacmanDummy), LengthOfArray<Uint16>(matlist_PacmanDummy), { 0 }, 6.18997f, NULL };

NJS_OBJECT object_PacmanDummy = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_PacmanDummy, 0, 0, 0, 0, 0, 0, 1, 1, 1, NULL, NULL }; //Unused GOOD! model

NJS_MATERIAL matlist_000E33C0[] = {
...
NJS_MESHSET_SADX meshlist_000E36D0[] = {
	{ NJD_MESHSET_3 | 0, 4, poly_000E33E8, NULL, NULL, NULL, uv_000E34E0, NULL },
	{ NJD_MESHSET_4 | 0, 10, poly_000E3400, NULL, NULL, NULL, uv_000E3510, NULL },
	{ NJD_MESHSET_4 | 1, 18, poly_000E3450, NULL, NULL, NULL, uv_000E35B0, NULL }
};

NJS_VECTOR vertex_000E3718[] = {
	{ 1.028529f, 0.072883f, -1.481784f },
	{ 1.020124f, 0.021118f, -1.510814f },
	{ 1.119372f, -0.17362f, -1.481784f },
	{ 1.116124f, -0.479128f, -1.39581f },
	{ 1.059668f, -0.72374f, -1.231072f },
	{ 1.64325f, 0.355556f, -1.134108f },
	{ 1.633363f, 0.276778f, -1.156327f },
	{ 1.631091f, -0.120311f, -1.134109f },
	{ 1.579845f, -0.425993f, -1.068307f },
	{ 1.468659f, -0.6768759f, -0.942222f },
	{ 1.900643f, 0.444512f, -0.540122f },
	{ 1.919734f, 0.382807f, -0.550703f },
	{ 1.960024f, -0.082622f, -0.613775f },
	{ 1.889694f, -0.390491f, -0.578163f },
	{ 1.741938f, -0.6455629f, -0.509927f },
	{ 2.072291f, 0.3724f, 0 },
	{ 2.101156f, 0.316401f, 0.000001f },
	{ 2.056095f, -0.06628799f, 0 },
	{ 1.998497f, -0.378024f, 0 },
	{ 1.837901f, -0.634568f, 0 },
	{ 1.900642f, 0.444512f, 0.540123f },
	{ 1.919733f, 0.382807f, 0.5507039f },
	{ 1.960024f, -0.082622f, 0.613775f },
	{ 1.889693f, -0.390491f, 0.578164f },
	{ 1.741937f, -0.6455629f, 0.509927f },
	{ 1.643249f, 0.355556f, 1.134109f },
	{ 1.633362f, 0.276778f, 1.156328f },
	{ 1.63109f, -0.120312f, 1.134109f },
	{ 1.579844f, -0.425993f, 1.068307f },
	{ 1.468658f, -0.6768759f, 0.942222f },
	{ 1.028527f, 0.072883f, 1.481784f },
	{ 1.020123f, 0.021118f, 1.510814f },
	{ 1.119371f, -0.17362f, 1.481784f },
	{ 1.116123f, -0.479128f, 1.39581f },
	{ 1.059667f, -0.72374f, 1.231072f },
	{ 1.031838f, 0.055678f, -1.586077f },
	{ 1.688701f, 0.319756f, -1.179574f },
	{ 2.028463f, 0.426354f, -0.545413f },
	{ 2.163171f, 0.323907f, 0.000001f },
	{ 2.028463f, 0.426354f, 0.545413f },
	{ 1.688701f, 0.319756f, 1.179575f },
	{ 1.031837f, 0.055678f, 1.586077f }
};

NJS_VECTOR normal_000E3910[] = {
	{ -0.267731f, 0.94513f, -0.187217f },
	{ 0.589683f, -0.527074f, -0.611937f },
	{ 0.555062f, -0.14401f, -0.819248f },
	{ 0.55309f, -0.408314f, -0.726203f },
	{ 0.5209799f, -0.55626f, -0.6474209f },
	{ 0.123695f, 0.897314f, -0.423707f },
	{ 0.705586f, -0.52981f, -0.470584f },
	{ 0.7255549f, -0.105835f, -0.679977f },
	{ 0.6820379f, -0.403245f, -0.610096f },
	{ 0.632247f, -0.552942f, -0.542696f },
	{ 0.254089f, 0.958448f, -0.129677f },
	{ 0.765318f, -0.583478f, -0.271739f },
	{ 0.927465f, -0.094251f, -0.361837f },
	{ 0.870284f, -0.373711f, -0.320853f },
	{ 0.793124f, -0.536541f, -0.288232f },
	{ 0.292294f, 0.956329f, 0 },
	{ 0.772429f, -0.6350949f, -0.00278f },
	{ 0.994597f, -0.10376f, -0.003331f },
	{ 0.929936f, -0.36772f, -0.000938f },
	{ 0.847616f, -0.530611f, 0 },
	{ 0.25409f, 0.958448f, 0.129677f },
	{ 0.77948f, -0.565783f, 0.268887f },
	{ 0.929144f, -0.10355f, 0.354921f },
	{ 0.864571f, -0.38827f, 0.319004f },
	{ 0.793124f, -0.536541f, 0.288233f },
	{ 0.123696f, 0.897313f, 0.423708f },
	{ 0.699358f, -0.539851f, 0.468465f },
	{ 0.72221f, -0.093953f, 0.685263f },
	{ 0.684009f, -0.394199f, 0.613791f },
	{ 0.632248f, -0.552939f, 0.542698f },
	{ -0.26773f, 0.94513f, 0.187217f },
	{ 0.600801f, -0.460061f, 0.653745f },
	{ 0.539943f, -0.028477f, 0.84122f },
	{ 0.556172f, -0.390956f, 0.733366f },
	{ 0.520981f, -0.556258f, 0.647423f },
	{ 0.5714819f, -0.193343f, -0.7975129f },
	{ 0.6819839f, 0.07453699f, -0.727559f },
	{ 0.930846f, 0.132141f, -0.340684f },
	{ 0.997706f, -0.067692f, 0 },
	{ 0.930845f, 0.13214f, 0.340684f },
	{ 0.6819839f, 0.074535f, 0.727559f },
	{ 0.5714819f, -0.193344f, 0.7975129f }
};

NJS_MODEL_SADX attach_000E3B08 = { vertex_000E3718, normal_000E3910, LengthOfArray<Sint32>(vertex_000E3718), meshlist_000E36D0, matlist_000E33C0, LengthOfArray<Uint16>(meshlist_000E36D0), LengthOfArray<Uint16>(matlist_000E33C0), { 1.591647f, -0.139614f, 0 }, 1.69022f, NULL };

NJS_OBJECT object_000E3B30 = { NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_000E3B08, 0.051851f, -1.333605f, 0, 0, 0, 0, 1, 1, 1, NULL, NULL }; //Pacman eyes from Dreamcast